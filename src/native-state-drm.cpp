...
inline static bool valid_drm_node_path(std::string provided_node_path)
{
    return !provided_node_path.empty();
}

inline static bool invalid_drm_node_path(std::string provided_node_path)
{
